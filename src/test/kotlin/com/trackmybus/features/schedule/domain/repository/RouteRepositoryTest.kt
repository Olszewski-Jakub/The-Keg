...
class RouteRepositoryTest : KoinTest {
    ...
    fun `Add new route`() {
        ...
        val newRoute =
            Route("1", "1", "Route 1", "Route 1 Long", 1, "Description 1", "https://route1.com", "FFFFFF", "000000")
    ...
    fun `Add route with existing ID`() {
        ...
        val routeWithExistingId =
            Route(
                "1",
                "1",
                "Route with existing ID",
                "Route with existing ID Long",
                1,
                "Description 2",
                "https://route2.com",
                "FFFFFF",
    ...
    @Test
    fun `Get route with ID that does not exist`() =
        runBlocking {
    ...
    @Test
    fun `Update route with non-existent ID`() =
        runBlocking {
            val updatedRoute =
                Route(
                    "non-existent-id",
    ...
    @Test
    fun `Delete route with non-existing ID`() =
        runBlocking {
