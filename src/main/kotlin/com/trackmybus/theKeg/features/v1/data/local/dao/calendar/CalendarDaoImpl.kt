package com.trackmybus.theKeg.features.v1.data.local.dao.calendar
...
class CalendarDaoImpl(
    ...
    override suspend fun getAllCalendars(): Result<List<CalendarEntity>> =
        runCatching {
            dbFactory.dbQuery {
    ...
    override suspend fun getCalendarById(id: String): Result<CalendarEntity?> =
        runCatching {
            dbFactory.dbQuery {
    ...
    override suspend fun addCalendar(calendar: Calendar): Result<CalendarEntity> =
        runCatching {
            dbFactory.dbQuery {
                CalendarEntity.new {
    ...
    override suspend fun updateCalendar(calendar: Calendar): Result<Boolean> =
        runCatching {
            dbFactory.dbQuery {
    ...
    override suspend fun deleteCalendar(id: String): Result<Boolean> =
        runCatching {
            dbFactory.dbQuery {
