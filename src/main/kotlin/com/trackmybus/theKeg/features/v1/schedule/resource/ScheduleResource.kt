package com.trackmybus.theKeg.features.v1.schedule.resource
...
import com.trackmybus.theKeg.features.v1.schedule.domain.usecases.ScheduleUseCase
...
fun Route.getStopList() {
    ...
    get<Schedule.Stops.List> { listRequest ->
...
fun Route.getDepartureTimesFromStop() {
    ...
    get<Schedule.Stops.DepartureTimes> { request ->
...
fun Route.getRoutesPassingThroughStop() {
    ...
    get<Schedule.Stops.PassingRoutes> { request ->
        val stopId = request.stopId
...
fun Route.getShapesForTrip() {
    ...
    get<Schedule.Trips.Shapes> { request ->
