...
import com.trackmybus.theKeg.features.v1.domain.mapper.toDto
import com.trackmybus.theKeg.features.v1.domain.mapper.toRouteDto
import com.trackmybus.theKeg.features.v1.domain.mapper.toRouteStopInfoDto
...
class ScheduleUseCaseImp(
    ...
    private suspend fun saveRoute(routes: List<com.trackmybus.theKeg.features.v1.domain.model.Route>) {
