package com.trackmybus.theKeg.features.v1.schedule.data.local.dao.shape
...
class ShapeDaoImpl(
    ...
    override suspend fun getShapesByShapeId(shapeId: String): Result<List<ShapeEntity>> =
        runCatching {
            dbFactory.dbQuery {
                ShapeEntity.find { ShapesTable.shapeId eq shapeId }.toList()
            }
        }.onFailure {
            logger.error("Error getting shapes by shapeId: $shapeId", it)
        }
