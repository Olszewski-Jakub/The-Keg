...
class StopDaoImpl(private val logger: Logger, private val dbFactory: DatabaseFactory) : StopDao {
    override suspend fun getAllStops(): Result<List<StopEntity>> = runCatching {
        dbFactory.dbQuery {
    ...
    override suspend fun getStopById(id: String): Result<StopEntity?> = runCatching {
        dbFactory.dbQuery {
    ...
    override suspend fun addStop(stop: Stop): Result<StopEntity> = runCatching {
        dbFactory.dbQuery {
            StopEntity.new {
    ...
    override suspend fun updateStop(stop: Stop): Result<Boolean> = runCatching {
        dbFactory.dbQuery {
    ...
    override suspend fun deleteStop(id: String): Result<Boolean> = runCatching {
        dbFactory.dbQuery {
