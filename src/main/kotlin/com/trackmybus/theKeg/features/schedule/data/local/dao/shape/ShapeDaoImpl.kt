...
class ShapeDaoImpl(private val logger: Logger, private val dbFactory: DatabaseFactory) : ShapeDao {
    override suspend fun getAllShapes(): Result<List<ShapeEntity>> = runCatching {
        dbFactory.dbQuery {
    ...
    override suspend fun getShapeById(id: Int): Result<ShapeEntity?> = runCatching {
        dbFactory.dbQuery {
    ...
    override suspend fun addShape(shape: Shape): Result<ShapeEntity> = runCatching {
        dbFactory.dbQuery {
            ShapeEntity.new {
    ...
    override suspend fun updateShape(shape: Shape): Result<Boolean> = runCatching {
        dbFactory.dbQuery {
    ...
    override suspend fun deleteShape(id: Int): Result<Boolean> = runCatching {
        dbFactory.dbQuery {
