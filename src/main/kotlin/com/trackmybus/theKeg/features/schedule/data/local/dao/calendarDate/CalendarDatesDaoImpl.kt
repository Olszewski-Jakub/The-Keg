...
class CalendarDatesDaoImpl(private val logger: Logger, private val dbFactory: DatabaseFactory) : CalendarDatesDao {
    override suspend fun getAllCalendarDates(): Result<List<CalendarDateEntity>> = runCatching {
        dbFactory.dbQuery {
    ...
    override suspend fun getCalendarDateById(id: Int): Result<CalendarDateEntity?> = runCatching {
        dbFactory.dbQuery {
    ...
    override suspend fun addCalendarDate(calendar: CalendarDate): Result<CalendarDateEntity> = runCatching {
        dbFactory.dbQuery {
    ...
    override suspend fun updateCalendarDate(calendarDate: CalendarDate): Result<Boolean> = runCatching {
        dbFactory.dbQuery {
    ...
    override suspend fun deleteCalendarDate(id: Int): Result<Boolean> = runCatching {
        dbFactory.dbQuery {
