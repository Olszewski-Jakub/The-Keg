...
class StopTimeDaoImpl(private val logger: Logger, private val dbFactory: DatabaseFactory) : StopTimeDao {
    override suspend fun getAllStopTimes(): Result<List<StopTimeEntity>> = runCatching {
        dbFactory.dbQuery {
    ...
    override suspend fun getStopTimeById(id: Int): Result<StopTimeEntity?> = runCatching {
        dbFactory.dbQuery {
    ...
    override suspend fun addStopTime(stopTime: StopTime): Result<StopTimeEntity> = runCatching {
        dbFactory.dbQuery {
            StopTimeEntity.new {
    ...
    override suspend fun updateStopTime(stopTime: StopTime): Result<Boolean> = runCatching {
        dbFactory.dbQuery {
    ...
    override suspend fun deleteStopTime(id: Int): Result<Boolean> = runCatching {
        dbFactory.dbQuery {
