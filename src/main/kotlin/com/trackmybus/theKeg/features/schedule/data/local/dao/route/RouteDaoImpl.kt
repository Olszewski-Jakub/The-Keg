...
class RouteDaoImpl(private val logger: Logger, private val dbFactory: DatabaseFactory) : RouteDao {
    override suspend fun getAllRoutes(): Result<List<RouteEntity>> = runCatching {
        dbFactory.dbQuery {
    ...
    override suspend fun getRouteById(id: String): Result<RouteEntity?> = runCatching {
        dbFactory.dbQuery {
    ...
    override suspend fun addRoute(route: Route): Result<RouteEntity> = runCatching {
        dbFactory.dbQuery {
            RouteEntity.new {
    ...
    override suspend fun updateRoute(route: Route): Result<Boolean> = runCatching {
        dbFactory.dbQuery {
    ...
    override suspend fun deleteRoute(id: String): Result<Boolean> = runCatching {
        dbFactory.dbQuery {
