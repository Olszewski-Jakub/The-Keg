...
import com.trackmybus.theKeg.features.schedule.domain.mapper.toRouteDto
import com.trackmybus.theKeg.features.schedule.domain.mapper.toRouteStopInfoDto
...
class ScheduleUseCaseImp(
    ...
    private suspend fun saveRoute(routes: List<com.trackmybus.theKeg.features.schedule.domain.model.Route>) {
