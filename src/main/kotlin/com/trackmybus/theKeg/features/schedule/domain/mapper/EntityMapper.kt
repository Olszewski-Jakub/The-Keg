...
fun AgencyEntity.toModel() = Agency(
...
fun Agency.toEntity() = AgencyEntity.new {
...
fun CalendarEntity.toModel() = Calendar(
...
fun Calendar.toEntity() = CalendarEntity.new {
...
fun CalendarDateEntity.toModel() = CalendarDate(
    serviceId = this.serviceId?.value ?: "",
...
fun CalendarDate.toEntity() = CalendarDateEntity.new {
...
fun FeedInfoEntity.toModel() = FeedInfo(
...
fun FeedInfo.toEntity() = FeedInfoEntity.new {
...
fun Route.toEntity() = RouteEntity.new {
...
fun Shape.toEntity() = ShapeEntity.new {
...
fun Stop.toEntity() = StopEntity.new {
...
fun StopTimeEntity.toModel() = StopTime(
...
fun StopTime.toEntity() = StopTimeEntity.new {
...
fun Trip.toEntity() = TripEntity.new {
    routeId = EntityID(this@toEntity.routeId, RoutesTable)
    serviceId = EntityID(this@toEntity.serviceId, CalendarsTable)
    tripId = EntityID(this@toEntity.tripId, TripsTable)
