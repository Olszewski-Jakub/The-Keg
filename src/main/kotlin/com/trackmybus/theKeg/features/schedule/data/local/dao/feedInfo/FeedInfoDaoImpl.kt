...
class FeedInfoDaoImpl(private val logger: Logger, private val dbFactory: DatabaseFactory) : FeedInfoDao {
    override suspend fun getAllFeedInfo(): Result<List<FeedInfoEntity>> = runCatching {
        dbFactory.dbQuery {
    ...
    override suspend fun getFeedInfoById(id: Int): Result<FeedInfo?> = runCatching {
        dbFactory.dbQuery {
    ...
    override suspend fun addFeedInfo(feedInfo: FeedInfo): Result<FeedInfoEntity> = runCatching {
        dbFactory.dbQuery {
            FeedInfoEntity.new {
    ...
    override suspend fun updateFeedInfo(feedInfo: FeedInfo): Result<Boolean> = runCatching {
        dbFactory.dbQuery {
    ...
    override suspend fun deleteFeedInfo(id: Int): Result<Boolean> = runCatching {
        dbFactory.dbQuery {
