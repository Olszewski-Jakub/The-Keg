...
class TripDaoImpl(private val logger: Logger, private val dbFactory: DatabaseFactory) : TripDao {
    override suspend fun getAllTrips(): Result<List<TripEntity>> = runCatching {
        dbFactory.dbQuery {
    ...
    override suspend fun getTripById(id: String): Result<TripEntity?> = runCatching {
        dbFactory.dbQuery {
    ...
    override suspend fun addTrip(trip: Trip): Result<TripEntity> = runCatching {
        dbFactory.dbQuery {
            TripEntity.new {
    ...
    override suspend fun updateTrip(trip: Trip): Result<Boolean> = runCatching {
        dbFactory.dbQuery {
    ...
    override suspend fun deleteTrip(id: String): Result<Boolean> = runCatching {
        dbFactory.dbQuery {
