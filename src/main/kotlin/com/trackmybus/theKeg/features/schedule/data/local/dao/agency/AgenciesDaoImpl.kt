...
class AgenciesDaoImpl(private val logger: Logger, private val dbFactory: DatabaseFactory) : AgenciesDao {
    override suspend fun getAllAgencies(): Result<List<AgencyEntity>> = runCatching {
        dbFactory.dbQuery {
    ...
    override suspend fun getAgencyById(id: String): Result<AgencyEntity?> = runCatching {
        dbFactory.dbQuery {
    ...
    override suspend fun addAgency(agency: Agency): Result<AgencyEntity> = runCatching {
        dbFactory.dbQuery {
            AgencyEntity.new {
    ...
    override suspend fun updateAgency(agency: Agency): Result<Boolean> = runCatching {
        dbFactory.dbQuery {
    ...
    override suspend fun deleteAgency(id: String): Result<Boolean> = runCatching {
        dbFactory.dbQuery {
    ...
    private fun AgencyEntity.setProperties(agencyId:String,agencyName: String?, agencyUrl: String?, agencyTimezone: String?) {
