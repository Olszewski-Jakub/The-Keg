...
class TripRepositoryImpl(private val logger: Logger, private val tripDao: TripDao): TripRepository {
    ...
    override suspend fun add(calendar: Trip): Result<Trip> {
        ...
        return tripDao.addTrip(calendar)
            .mapResult { it.toModel() }
            .also { result ->
    ...
    override suspend fun update(calendar: Trip): Result<Boolean> {
        ...
        return tripDao.updateTrip(calendar)
            .mapResult { it }
            .also { result ->
